...
export function SubscriptionList() {
  const { data: subscriptions, refetch, isLoading, isRefetching } = trpc.subscription.list.useQuery();
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="ml-4">
                  {subscription.isActive && (
                    <Button
                      onClick={() => deactivateSubscription.mutate({ endpoint: subscription.endpoint })}
                      variant="destructive"
                      size="sm"
                    >
                      停用
